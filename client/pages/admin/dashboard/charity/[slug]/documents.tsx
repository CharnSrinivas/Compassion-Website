                    ...
                    <div className="lg:w-full mx-auto justify-evenly flex gap-2 flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <div className="flex mb-4">
                                <a href={`/admin/dashboard/charity/${slug}/details`} className="flex-grow border-b-2  py-2 text-lg px-1  border-gray-300">
                                    Details
                                </a>
                                <a href={`/admin/dashboard/charity/${slug}/documents`} className="flex-grow text-indigo-500 border-indigo-500  border-b-2 py-2 text-lg px-1">
                                    Documents
                                </a>
                            </div>
                            ...
                            <div>
                                {charity.documents &&
                                    <div className='flex flex-wrap gap-4 py-5  border-b-2 mb-8 border-b-gray-300'>
                                        {(charity.documents as any[]).map((document) => {
                                            return (
