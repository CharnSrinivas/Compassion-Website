...
export default function edit({ donation, admin_token, id }: Props) {
    ...
    const _delete = async () => {
        try {
            setDeleting(true);
            let res = await fetch(server_url + '/content-manager/collection-types/api::donation.donation/' + donation.id, {
                method: "DELETE", headers: {
                    Authorization: `Bearer ${admin_token}`,
                }
            });
            window.location.href = '/admin/dashboard/donation'
            setDeleting(false)
        } catch (error) {
            setDeleting(false);
        }
                    ...
                    <div className="lg:w-full mx-auto justify-evenly flex gap-2 flex-wrap">
                        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                            ...
                            <div className='flex flex-wrap gap-4 mt-8'>
                                ...
                                <button onClick={_delete} className={`flex gap-1 text-red-400  hover:text-white   items-center  hover:bg-red-400    border-2 border-red-400 py-0 px-4 focus:outline-none rounded`}>
                                    Delete
                                    {!deleting &&
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
