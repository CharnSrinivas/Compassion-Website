...
export async function getServerSideProps(context: GetServerSidePropsContext): Promise<GetServerSidePropsResult<Record<string, unknown>>> {
  ...
  const charities_page = context.query['cp'];
  const fp = parseInt(fundraisers_page ? fundraisers_page.toString() : '1');
  const cp = parseInt(charities_page ? charities_page.toString() : '1');
...
export default function index({ donations_meta, fund_raisers_meta, charity_donations_meta, pending_approval, pending_charity_approval, fundraisers, charities, charities_meta }: Props) {
                                ...
                                <div className="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                  {fundraiser['image'] &&
                                    <img
                                      ...
                                      src={`${server_url}${fundraiser['image']['formats'] != null ? fundraiser['image']['formats']['thumbnail']['url'] : fundraiser['image']['url']}`}
                                      alt=""
                                      loading="lazy"
                                    />
                                  }
