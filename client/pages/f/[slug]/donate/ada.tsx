...
export default function donate({ fundraiser, slug, user, strapi_publisable_key, token, crypto_data, currency_data }: Props) {
    ...
    const ada_address = 'DdzFFzCqrhsvxqrpCgB2GRpGyWEyuWrFGbQQfFz7nYPNha5FAASMn3sebQiYTWQJi1qboF6JrjSbFQKY8xf6EQqB8uBUQfvE4XAJ6Xwr'
                ...
                <div className="flex flex-col border p-8 px-10 lg:w-[45%] bg-white shadow-xl w-[95%]  mx-auto rounded-xl">
                    ...
                    <div className="w-full mx-auto mt-5 bg-[#eaf3f9] border-2 border-[#579cce]  flex-row flex justify-between flex-wrap items-center items-start p-4">
                        ...
                        <div className='flex flex-col items-end '>
                            <div className='flex flex-row items-center gap-2'>
                                <img className='w-8 h-8' src="/assets/ada.png" alt="cardano con" />
                    ...
                    <div className='flex flex-col  shadow-md px-5 py-5 items-start'>
                        <div className='flex flex-row justify-between  items-start w-[100%]'>
                            <p className='font-medium text-gray-400'>ADA deposit Address</p>
                            <svg
                                onClick={() => {
                                    navigator.clipboard.writeText(ada_address).then(() => {
                        ...
                        <p className='overflow-scroll lg:overflow-auto w-full font-medium text-gray-600 '>{ada_address}</p>
                    </div>
                    <label
                        htmlFor="img-upload"
...
export async function getServerSideProps(context: GetServerSidePropsContext): Promise<GetServerSidePropsResult<Record<string, unknown>>> {
    try {
        ...
        //     },
        // });
        let crypto_data = await new CoinGeckoApi().coins.fetch('cardano', {});
