    ...
    return (
        <section>
            <div className='px-8 py-12 lg:w-[60%] w-[90%] mx-auto mt pt-[5rem] flex lg:flex-row flex-col  gap-8 justify-between'>
                <div>
                    <h1 className='font-semibold my-4 text-4xl text-gray-700'>Get help with animals fundraising
                    </h1>
                    <h3 className='text-gray-600 my-1 font-poppins  text-[1.1rem]'>With a Compassion, you can get immediate help with animals costs.
                    </h3>
                ...
                <img className=' w-[100%] lg:w-[45%] h-[13rem] lg:h-[32rem] object-cover lg:ml-11' src="https://d25oniaj7o2jcw.cloudfront.net/photo-category-animals@2x.jpg" alt="Animals" />
            </div>
            <hr />
            <div className=' w-full bg-[#fbf8f6] py-5'>
                <div className='px-8 mx-auto w-90% lg:w-[60%] pt-[5rem]'>
                    <div className='mb-5'>
                        <h1 className='font-semibold mb-1 text-3xl text-gray-700'>Trending in animals fundraising</h1>
