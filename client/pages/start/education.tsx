    ...
    return (
        <section>
            ...
            <div className='px-8 py-12 lg:w-[60%] w-[90%] mx-auto mt pt-[5rem] flex lg:flex-row flex-col  gap-8 justify-between'>
                <div>
                    <h1 className='font-semibold my-4 text-4xl text-gray-700'>Get help with educational fundraising
                    </h1>
                    <h3 className='text-gray-600 my-1 font-poppins  text-[1.1rem]'>With a Compassion, you can get immediate help with educational support.
                    </h3>
                ...
                <img className=' w-[100%] lg:w-[45%] h-[13rem] lg:h-[32rem] object-cover lg:ml-11' src="https://d25oniaj7o2jcw.cloudfront.net/photo-category-education-uk@2x.jpg" alt="education" />
            </div>
            <hr />
