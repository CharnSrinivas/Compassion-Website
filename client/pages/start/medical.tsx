    ...
    return (
        <section>
            ...
            <div className='px-8 py-12 lg:w-[60%] w-[90%] mx-auto mt pt-[5rem] flex lg:flex-row flex-col  gap-8 justify-between'>
                ...
                <img className=' w-[100%] lg:w-[45%] h-[13rem] lg:h-[32rem] object-cover lg:ml-11' src="https://d25oniaj7o2jcw.cloudfront.net/photo-category-medical-uk@2x.jpg" alt="medical" />
            </div>
            <hr />
            <div className=' w-full bg-[#fbf8f6] py-5'>
                <div className='px-8 mx-auto w-90% lg:w-[60%] pt-[5rem]'>
                    <div className='mb-5'>
                        <h1 className='font-semibold mb-1 text-3xl text-gray-700'>Trending in medical fundraising</h1>
